...
def finde_intraday_reaktionszonen_baender(
    ...
    # Wichtig: Zonen mit mehreren Reaktionen zuerst, bei Gleichstand die
    # aktuelleren. Maximal `top_n` Zonen werden im Intraday-Chart gezeigt.
    zonen.sort(key=lambda z: (-z["treffer"], -z["letzter_index"]))

    return {
        "reaktionszonen": zonen[:top_n],
