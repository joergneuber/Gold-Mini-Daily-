...
- Trenne drei Entwicklungsstufen strikt voneinander: (1) der bereits berechnete Szenario-Trigger aktiviert das bestehende Bull-/Bär-Szenario, (2) die aktuell berechnete obere bzw. untere Kanalbegrenzung markiert den strukturellen Kanal-Ausbruch bzw. Kanal-Bruch, und (3) bereits berechnete übergeordnete Widerstands-/Durchschnittsstrukturen liefern die weitere Bestätigung. Ordne diese Strukturen dabei immer nach ihrer tatsächlichen Lage zur Kanalgrenze: Eine Marke unterhalb der oberen Kanalgrenze bzw. oberhalb der unteren Kanalgrenze ist eine vorgelagerte Hürde innerhalb der Struktur und darf NICHT als erst nach dem Kanalausbruch folgende Bestätigung bezeichnet werden; nur tatsächlich über der oberen bzw. unter der unteren Kanalgrenze liegende Strukturen sind nachgelagerte Bestätigungen. Ein Szenario-Trigger ist NICHT automatisch ein Kanal-Ausbruch.
