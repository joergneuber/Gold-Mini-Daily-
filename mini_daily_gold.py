...
- Trenne drei Entwicklungsstufen strikt voneinander: (1) der bereits berechnete Szenario-Trigger aktiviert das bestehende Bull-/Bär-Szenario, (2) die aktuell berechnete obere bzw. untere Kanalbegrenzung markiert den strukturellen Kanal-Ausbruch bzw. Kanal-Bruch, und (3) darüber bzw. darunter liegende bereits berechnete Widerstands-/Durchschnittsstrukturen liefern erst die weitere übergeordnete Bestätigung. Ein Szenario-Trigger ist NICHT automatisch ein Kanal-Ausbruch.
...
2. "Bestätigung:" – Stelle die drei Entwicklungsstufen klar getrennt dar: welcher bereits berechnete Szenario-Trigger aktiviert das Szenario, welche bereits berechnete Kanalbegrenzung wäre der strukturelle Ausbruch bzw. Kanal-Bruch und welche bereits berechneten darüberliegenden Widerstands-/Durchschnittsstrukturen liefern die weitere Bestätigung. Verwende nur die gelieferten Werte.
...
4. "Übergeordnet:" – Ordne die kurzfristige Entwicklung in die vorhandene Intraday-Chartstruktur und 6M-/Positionsstruktur ein. Formuliere einen Kanal-Ausbruch nicht als vollständige Trendwende; nenne die nächste übergeordnete Bestätigung nur anhand bereits gelieferter Widerstände bzw. Durchschnittsstrukturen.
...
- Wenn beide Werte verschieden sind, behandle sie als zwei aufeinanderfolgende Bestätigungsstufen.
